...
function szwergold_widgets_init() {
	...
	register_sidebar(array(
		...
		'before_widget' => '<div id="%1$s" class="widget %2$s col col-12 pe-md-3"><div class="p-0 m-0 py-1 mb-1 rounded-pill text-georgia-regular">',
	...
	register_sidebar(array(
		...
		'id'            => 'widget-header-2',
		'description'   => __('Add widgets here to appear in your post header.', 'szwergold'),
		'before_widget' => '<div id="%1$s" class="widget %2$s col col-12 pe-md-3"><div class="p-0 m-0 px-2 py-1 mb-1 rounded-pill text-georgia-regular">',
		'after_widget'  => '</div></div>',
		'before_title'  => '<div class="widget-title h5 text-capitalize p-0 m-0 pb-1 mb-2 border-bottom border-dark">',
		'after_title'   => '</div>',
	));
