    ...
    if ($upw_query->have_posts()) {
      ...
      while ($upw_query->have_posts()) {
        ...
        if (get_the_title() && $instance['show_title']) {
          $header =
              '<div class="h4 p-0 m-0 fw-bold" id="sidebar_post_' . $the_ID . '">'
        ...
        $bootstrap_column_break = 'col-md-6';
        ...
        if ($instance['show_excerpt'] && !empty($excerpt)) {
          ...
          if (isset($article_image) && !empty($article_image)) {
            $core .=
                '<div class="col col-12 ' . $bootstrap_column_break . ' m-0 p-0 pb-2 ps-md-3 float-end">'
              . '<a href="' . $permalink . '" title="' . $title . '" class="text-decoration-none text-dark">'
        ...
        /******************************************************************************/
        // Set the core column break.
        $bootstrap_column_break = 'col-md-12';

        /******************************************************************************/
        // Custom cointainer begins.
        $final[] =
            '<div class="col col-12 ' . $bootstrap_column_break . ' col-xl-12 m-0 p-0 pe-md-3 pe-xl-0">'
